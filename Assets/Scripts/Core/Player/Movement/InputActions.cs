...
namespace ElectrumGames.Core.Player.Movement
{
    ...
    ""maps"": [
        ...
        },
        {
            ...
            ""actions"": [
                ...
                {
                    ""name"": ""FlashLightInteraction"",
                    ""type"": ""Button"",
                    ""id"": ""7fea96bc-1ed0-4b54-9a8d-4243f9cc4e5d"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""83048dba-11a9-404c-a6ad-b41c2212bab0"",
                    ""path"": ""<Keyboard>/t"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                    ""action"": ""FlashLightInteraction"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                }
            ]
    ...
    ""controlSchemes"": [
        ...
        },
        {
            ...
            m_Interactions_FlashLightInteraction = m_Interactions.FindAction("FlashLightInteraction", throwIfNotFound: true);
        ...
        ~@InputActions()
        {
            ...
            UnityEngine.Debug.Assert(!m_UiEvents.enabled, "This will cause a leak and performance issues, InputActions.UiEvents.Disable() has not been called.");
            UnityEngine.Debug.Assert(!m_Boards.enabled, "This will cause a leak and performance issues, InputActions.Boards.Disable() has not been called.");
        }
        ...
        private readonly InputAction m_Interactions_FlashLightInteraction;
        ...
        public struct InteractionsActions
        {
            ...
            public InputAction @FlashLightInteraction => m_Wrapper.m_Interactions_FlashLightInteraction;
            ...
            public void AddCallbacks(IInteractionsActions instance)
            {
                ...
                @FlashLightInteraction.started += instance.OnFlashLightInteraction;
                @FlashLightInteraction.performed += instance.OnFlashLightInteraction;
                @FlashLightInteraction.canceled += instance.OnFlashLightInteraction;
        ...
        public interface IInteractionsActions
        {
            ...
            void OnFlashLightInteraction(InputAction.CallbackContext context);
