...
{
    public class InvisibleGhostEventLogic : BaseGhostEvent
    {
        public InvisibleGhostEventLogic(GhostController ghostController, GhostDifficultyData difficultyData, 
        ...
        {
            Debug.LogError("Invisible must to have special logic for ghost events!");
        }
    }
}