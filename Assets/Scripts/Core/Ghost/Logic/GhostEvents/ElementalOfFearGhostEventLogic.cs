...
{
    public class ElementalOfFearGhostEventLogic : BaseGhostEvent
    {
        public ElementalOfFearGhostEventLogic(GhostController ghostController, GhostDifficultyData difficultyData,
