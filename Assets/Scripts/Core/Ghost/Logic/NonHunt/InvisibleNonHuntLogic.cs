...
{
    public class InvisibleNonHuntLogic : BaseNonHuntLogic
    {
        public InvisibleNonHuntLogic(GhostController ghostController, GhostDifficultyData ghostDifficultyData,
