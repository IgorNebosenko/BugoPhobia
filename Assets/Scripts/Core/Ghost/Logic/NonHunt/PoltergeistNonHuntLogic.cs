...
{
    public class PoltergeistNonHuntLogic : BaseNonHuntLogic
    {
        public PoltergeistNonHuntLogic(GhostController ghostController, GhostDifficultyData ghostDifficultyData,
